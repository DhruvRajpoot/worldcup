...
--
-- Name: games_games_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.games_games_id_seq OWNER TO postgres;

--
-- Name: games_games_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: games_games_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE games_games_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE public.games_games_id_seq TO freecodecamp;
